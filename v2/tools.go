...
const randomStringSource = "abcdefghijklmnoqrstuvwxyzABCDEFGHIJKLMNOPQRSTUWXYZ0123456789_+"
...
// ReadJSON  trys to read the body of a request and converts it from JSON in to a go data variable
...
// ErrorJSON takes an error, and optionally status code, and generates and sends a JSON error message
